...
import { CORS_PROXY_URL } from './../config/CORS_PROXY';
  ...
  return (
    ...
    >
      <div className="relative h-screen">
        <div className="w-[480px] pr-[40px] pl-[20px]">
                ...
                <div className="relative cursor-pointer ">
                  <div className="table table-fixed px-6 py-5">
                    ...
                    <div className="table-cell align-middle">
                      <div className="text-base text-[#282c3f] font-medium hover:text-[#fc8019]">
                        {loading
                          ? "Fetching current location..."
                          : "Get Current Location"}
                      </div>
                      <div className="pt-1 text-[13px] leading-[1.3] text-[#93959f] hover:text-[#fc8019]">
                        Using GPS
                      </div>
                    </div>
                  </div>
